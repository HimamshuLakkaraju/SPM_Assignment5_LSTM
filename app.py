...
def forecast():
    ...
    # FACEBOOK PROPHET
    PROPHET_GENERATED = "prophet_generated_data" + type + "_" + repo_name + ".png"
    PROPHET_GENERATED2 = "prophet_generated_data2" + type + "_" + repo_name + ".png"
    PROPHET_GENERATED_URL = BASE_IMAGE_PATH + PROPHET_GENERATED
    PROPHET_GENERATED_URL2 = BASE_IMAGE_PATH + PROPHET_GENERATED2
    ...
    json_response = {
        ...
        "prophet_generated_image_url": PROPHET_GENERATED_URL,
        "prophet_generated_image_url2": PROPHET_GENERATED_URL2,
    }
